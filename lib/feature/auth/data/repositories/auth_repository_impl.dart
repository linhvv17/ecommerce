import 'dart:io';
import 'package:ecommerce/feature/auth/data/datasource/network_db/auth_network_db.dart';
...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<String> loginUser(
    ...
    return await authnetworkDB.loginUserUpbase(userCredentialEntity, context);
  }
